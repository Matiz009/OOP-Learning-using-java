...
public class Main {
    public static void main(String[] args) {
        ...
        BoxWithWeight box2 = new BoxWithWeight(5,2,3,4,5);//It is the type of object which determines which members can be accessed
        ...
        Box box3=new BoxPrice(20,25,30,35,40,45);
